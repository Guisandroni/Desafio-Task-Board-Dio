...
import org.dev.gui.service.BoardColumnQueryService;
import org.dev.gui.service.BoardQueryService;
import org.dev.gui.service.CardQueryService;
import org.dev.gui.service.CardService;
    ...
    public class Board {
        ...
        private void moveCardToNextColumn() throws SQLException {
            ...
            var boardColumnsInfo = entity.getBoardColumns().stream()
                    .map(bc -> new BoardColumnInfo(bc.getId(), bc.getOrder(), bc.getKind()))
                    .toList();
            try(var connection = getConnection()){
